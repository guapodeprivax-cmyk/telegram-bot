...
# ----------------- OWNER / PERMISSIONS -----------------
OWNER_ID = 7844678082
owners = set([OWNER_ID])  # Owner principal + secondaires
whitelist = {}            # {chat_id: set(user_id)}
clear_whitelist = {}      # {chat_id: set(user_id)}
BOT_LOGS = {}             # {chat_id: group_id pour logs commande}
MESSAGE_LOGS = {}         # {chat_id: group_id pour messages supprimés}
pending_config = {}       # {user_id: action en cours}
bot_status = {}           # {chat_id: True/False}
sniped = {}               # {chat_id: dernier message supprimé}
